...
<body>
    <form action="{{url('studr')}}" method="post" style="border: 2px solid black;width: 50%;margin-left: 20%;margin-top: 20px;" onsubmit="return validate()" name="form1">
    @csrf
        <h2 align="center">Student Registration</h2>
        <hr width="50%">
        <div class="row" style="padding-left: 40%;">
            <label for="">Name:</label>&nbsp;&nbsp;
            <input type="text" name="tname" id="" style="padding-left: 10%;">
        </div>
        <br>
        <div class="row" style="padding-left: 40%;">
            <label for="">Contact:</label>&nbsp;
            <input type="text" name="tcont" id="" style="padding-left: 10%;">
        </div>
        <br>
        <div class="row" style="padding-left: 40%;">
            <label for="">Email:</label>&nbsp;&nbsp;&nbsp;
            <input type="text" name="tmail" id="" style="padding-left: 10%;">
        </div>
        <br>
        <div class="row" style="padding-left: 40%;">
            <label for="">Username:</label>&nbsp;&nbsp;
            <input type="text" name="tuname" id="" style="padding-left: 10%;">
        </div>
        <br>
        <div class="row" style="padding-left: 40%;">
            <label for="">Password:</label>&nbsp;&nbsp;
            <input type="text" name="tpass" id="" style="padding-left: 10%;">
        </div>
        <br>
        <div class="row" style="padding-left: 40%;">
            <label for="">Confirm password:</label>&nbsp;&nbsp;
            <input type="text" name="cpas" id="" style="padding-left: 10%;">
        </div>
        <br>
        <div class="row" style="padding-left: 40%;">

            <button type="submit" style="display: block;width: 50%;">Register</button>
        </div>
        <p>{{session('message')}}</p>
